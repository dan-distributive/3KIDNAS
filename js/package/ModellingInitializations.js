module.declare(["./TiltedRing.js","./ParameterVector.js","./ParameterToTiltedRingVector.js","./UnitConversions.js"], function (require, exports, module) {
'use strict';
...
const { ParameterVector, allocateParamVector }
  = require('./ParameterVector.js');
const { tiltedRingOptionsToPV }
  = require('./ParameterToTiltedRingVector.js');
const { msolPc2ToJyAS2 } = require('./UnitConversions.js');
