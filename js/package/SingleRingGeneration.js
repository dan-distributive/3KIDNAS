module.declare(["./TiltedRing.js","./fdlibm.js","./fdlibm-wasm.js"], function (require, exports, module) {
'use strict';
...
const jsFdlibm = require('./fdlibm.js');
...
async function warmUpWasmTrig() {
  if (!wasmTrigModulePromise) {
    wasmTrigModulePromise = (async () => {
      const fdlibmWasm = require('./fdlibm-wasm.js');
...
if (require.main === module) {
  ...
  const { Ring }                = require('./TiltedRing.js');
  const { ring_ParticleAllocation } = require('./TiltedRing.js');
