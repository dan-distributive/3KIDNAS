module.declare(["./TiltedRingModelGeneration.js","./FillDataCubeByTiltedRing.js","./CubeKernelConvolution.js","./CubeComparison.js"], function (require, exports, module) {
'use strict';
...
const { buildTiltedRingModel }          = require('./TiltedRingModelGeneration.js');
const { fillDataCubeWithTiltedRing }    = require('./FillDataCubeByTiltedRing.js');
...
if (require.main === module) {
  ...
  const { TiltedRingModel, TiltedRingFittingOptions,
          ...
          logicalTiltedRingIndexing }  = require('./TiltedRing.js');
  ...
  const { generalizedParamVectorToTiltedRing } = require('./ParameterToTiltedRingVector.js');
  ...
  const { tiltedRingOptionsToPV } = require('./ParameterToTiltedRingVector.js');
