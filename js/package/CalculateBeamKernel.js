module.declare(["./Beam.js","./fdlibm.js"], function (require, exports, module) {
'use strict';
...
const { kernelGet, kernelSet } = require('./Beam.js');
const { fdCos, fdSin, fdExp } = require('./fdlibm.js');
...
if (require.main === module) {
  const { Beam2D, allocate_Beam2D, kernelGet } = require('./Beam.js');
